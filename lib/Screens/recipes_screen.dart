...
import 'package:nosh_task/Provider/dishProvider.dart';
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: ListView.builder(
                ...
                itemCount: dishProvider.items.length,
                itemBuilder: (context,index){
                  var dish = dishProvider.items[index];
                  return Padding(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(image: NetworkImage(dish.imageUrl))
                    ),
                    child: Stack(
                      children: [
                        Positioned(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(dish.dishName,style: bRecipeHeadingStyle,),
                        height4,
                        Row(
